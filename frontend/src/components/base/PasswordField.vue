...
<template>
  <label class="block">
    ...
    <span class="relative block">
      ...
      >
        <svg v-if="visible" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
